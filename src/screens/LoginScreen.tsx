      ...
      <div className="grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-xl bg-white shadow-2xl lg:grid-cols-12 min-h-[600px]">
        ...
        <div className="relative hidden flex-col justify-between p-12 lg:col-span-5 lg:flex bg-[#0f172a] overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="font-headline text-3xl font-extrabold tracking-tight text-white">Teachers Digital Diary</h1>
            <p className="mt-2 font-sans text-sm text-blue-100/60 uppercase tracking-widest font-bold">Subika Singha • 571 No Chalitakandi LP School</p>
          </div>
          <div className="relative z-10">
        ...
        <div className="flex flex-col justify-center p-8 md:p-16 lg:col-span-7 bg-white">
          <div className="mx-auto w-full max-w-sm">
            <div className="mb-12 lg:hidden">
              <h1 className="font-headline text-2xl font-extrabold text-accent">Teachers Digital Diary</h1>
            </div>
            <div className="mb-10">
            ...
            <form onSubmit={(e) => { e.preventDefault(); onNavigate('dashboard'); }} className="space-y-6">
              <div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-text-light leading-relaxed">
                    Use <span className="font-semibold text-accent">admin</span> as username and <span className="font-semibold text-accent">Subu</span> for the secret passphrase to unlock Subika Singha - 571 No Chalitakandi LP School profile.
                  </p>
                </div>
              </div>
            </div>
